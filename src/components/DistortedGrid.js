...
const GridDistortion = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      console.log('GridDistortion: Mouse move detected');
    ...
    const handleMouseLeave = () => {
      console.log('GridDistortion: Mouse leave detected');
      dataTexture.needsUpdate = true;
    ...
    console.log('GridDistortion: Event listeners added to container:', container);
    ...
    console.log('GridDistortion: Animation started');
